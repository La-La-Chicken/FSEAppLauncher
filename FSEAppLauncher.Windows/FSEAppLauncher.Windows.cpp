...
// FSEAppLauncher.Windows.cpp: Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CFSEAppLauncherApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CFSEAppLauncherApp construction

CFSEAppLauncherApp::CFSEAppLauncherApp() {
	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}


// The one and only CFSEAppLauncherApp object

CFSEAppLauncherApp theApp;


// CFSEAppLauncherApp initialization
